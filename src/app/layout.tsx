...
export const metadata: Metadata = {
  title: "TravelPro - Discover Amazing Destinations & Tour Packages",
  description: "Experience unforgettable adventures with TravelPro's curated travel packages to the world's most beautiful destinations. Book your dream vacation today.",
  keywords: ["travel", "tourism", "vacation packages", "destinations", "tours", "travel booking", "adventure travel"],
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "TravelPro - Discover Amazing Destinations & Tour Packages",
    description: "Experience unforgettable adventures with TravelPro's curated travel packages to the world's most beautiful destinations.",
    siteName: "TravelPro",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/457882/pexels-photo-457882.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Beautiful tropical destination for travel"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "TravelPro - Discover Amazing Destinations",
    description: "Experience unforgettable adventures with curated travel packages to the world's most beautiful destinations.",
    images: ["https://images.pexels.com/photos/457882/pexels-photo-457882.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  }
};
